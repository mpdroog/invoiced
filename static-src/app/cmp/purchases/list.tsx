...
export default class PurchasesPage extends React.Component<PurchasesPageProps, PurchasesPageState> {
  ...
  private ajax(): void {
    Axios.get("/api/v1/purchases/" + this.props.entity + "/" + this.props.year, {
      params: {
        from: 0,
        count: 0,
      },
    ...
    return (
      <div className="row">
        <div className="col-sm-12">
          <PurchaseInvoices
            title="Unpaid"
            bucket="purchase-invoices-unpaid"
            items={this.state.unpaid}
            entity={this.props.entity}
            year={this.props.year}
          />
          <PurchaseInvoices
            title="Paid"
            bucket="purchase-invoices-paid"
            items={this.state.paid}
            entity={this.props.entity}
            year={this.props.year}
          />
        </div>
