...
export default class TaxesPage extends React.Component<TaxesPageProps, TaxesPageState> {
  ...
  private async ajax(): Promise<void> {
    const res = await Axios.post<TaxSummary>(
      "/api/v1/taxes/" + this.props.entity + "/" + this.props.year + "/" + this.state.quarter
    );
              ...
              <table className="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th className="text-end">Omzetbelasting</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                ...
                <table className="table table-striped">
                  <thead>
                    <tr>
                      <th>Rubriek</th>
                      <th>BTW-nummer</th>
                      <th className="text-end">Levering</th>
                    </tr>
                  </thead>
                  <tbody>{icp}</tbody>
                </table>
            ...
            <div className="float-end">
              <div className="btn-group nm7">
                <a
                  ...
                  href={"/api/v1/summary/" + this.props.entity + "/" + this.props.year + "?excel=1"}
                >
