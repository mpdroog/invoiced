          ...
          <div className="col-md-3">
            <div className="card stats">
              <div className="card-body">
                ...
                <div className="stats-info">{data.unpaid.Count} invoices pending payment</div>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card stats">
              <div className="card-body">
                ...
                <div className="stats-info">{data.unbilledHours.Count} hour sheets to bill</div>
              </div>
            </div>
          </div>
          <div className="col-md-3">
                ...
                <div className="stats-info">
                  {
                    <span className={growthPositive ? "text-success" : "text-danger"}>
                      {growthPositive ? "+" : ""}
                      {data.yearComparison.GrowthPercent}% vs {data.yearComparison.PreviousYear}
                    </span>
                  }
                </div>
              </div>
          ...
          <div className="col-md-3">
            <div className="card stats">
              <div className="card-body">
                ...
                <div className="stats-info">invoices past due date</div>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <tbody>
                      {data.overdue.map((inv) => (
                        <tr key={inv.ID}>
                          ...
                          <td>
                            <a
                              href={`#${entity}/${year}/invoices/edit/Q${inv.Quarter}/${inv.ID}`}
                      ...
                      <li key={commit.hash} className="d-flex align-items-start mb-3">
                        ...
                        <div>
                          ...
                          <small className="text-muted">
                            {commit.author} &middot; {fromNow(commit.date)} &middot;{" "}
                            {formatDate(commit.date, "YYYY-MM-DD HH:mm")}
                          </small>
                        </div>
                      </li>
                    ))}
