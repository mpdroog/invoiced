  ...
  async send(): Promise<void> {
    ...
    await Axios.post(
      "/api/v1/invoice/" +
        ...
        parent.props.year +
        "/" +
        parent.state.State.currentBucket +
        "/" +
        meta.Conceptid +
        "/email",
      req
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="mb-3">
                ...
                />
                {this.state.toError !== null && <div className="invalid-feedback">{this.state.toError}</div>}
              ...
              <div className="mb-3">
                ...
                <textarea onChange={this.update.bind(this)} id="Body" className="form-control" rows={8}>
                  {parentMail.Body}
                </textarea>
              </div>
              <div className="mb-0">
                ...
                <div className="d-flex flex-wrap gap-3">
                  ...
                  <a
                    ...
                    className="btn btn-outline-secondary btn-sm"
                  >
                    <i className="fas fa-building-columns me-1"></i>
                    {parentMeta.Invoiceid}.xml
                  </a>
            ...
            <div className="modal-footer">
              <button onClick={this.props.onHide} className="btn btn-secondary" type="button">
                Cancel
              </button>
