...
export default class GitPage extends React.Component<GitPageProps, GitState> {
  ...
  render(): React.JSX.Element {
    ...
    if (this.state.loading) {
      content = (
        <p>
          <i className="fas fa-spinner fa-spin"></i> Loading git status...
        </p>
      );
        ...
        <div>
          <div className="row m-b-md">
            <div className="col-md-6">
              <p>
                <strong>Remote:</strong> {status.remote !== "" ? status.remote : "Not configured"}
              </p>
              <p>
                <strong>Commits ahead:</strong> {status.ahead}
              </p>
            </div>
            <div className="col-md-6 text-end">
              <ActionButton className="btn btn-secondary m-r-sm" onClick={this.doPull.bind(this)}>
              ...
              {status.ahead > 0 && (
                <ActionButton className="btn btn-danger" onClick={this.doDiscardAll.bind(this)}>
          ...
          {this.state.actionResult != null && <div className="alert alert-info">{this.state.actionResult}</div>}
