        ...
        <div className="container">
          ...
          <div className={"collapse navbar-collapse" + (menuOpen ? " show" : "")}>
                ...
                <div className="search-dropdown">
                  {searching ? (
                    ...
                    searchResults.map((r, i) => (
                      <div key={i} className="search-result-item" onClick={() => this.handleResultClick(r)}>
            ...
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item">
                <ActionButton className="nav-link btn btn-link" onClick={() => this.handleLogout()} title="Logout">
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <ActionButton className="btn btn-success" onClick={() => this.handleLogin()}>
                Login
              </ActionButton>
            </div>
          </div>
