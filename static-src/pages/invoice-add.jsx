      ...
      <table className="table">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div className="input-group">
                <input className="form-control" disabled="disabled" type="text" data-key="Meta.Issuedate" onChange={that.handleChange} value={inv.Meta.Issuedate} placeholder="AUTOGENERATED"/>
                <div className="input-group-addon"><a onClick={this.toggleLock}><i className="fa fa-lock"></i></a></div>
              </div>
            </td>
          </tr>
